...
pygame.time.set_timer(CREAT_BONUS, 2500)
CHANCH_IMAGE = pygame.USEREVENT + 3
pygame.time.set_timer(CHANCH_IMAGE, 200)
...
while playing:
    ...
    main_display.blit(FONT.render(str(score), 
                        True, COLOR_WHITE), 
                        (WIDTH-50, 20))
